"""
Figure 10: Sky 3 Results - Overcast Sequence Visualization
...
Based on the pipeline.py processing for Sky 3 sequence.
"""
...
def load_processed_frames():
    ...
    video_path = os.path.join(OUTPUT_FOLDER, 'sky3.mp4')
...
def create_sky3_results_figure():
    """Create the comprehensive Sky 3 results figure"""
    print("="*60)
    print("GENERATING SKY 3 RESULTS FIGURE")
    print("="*60)
    ...
    fig.suptitle('Sky 3 Results - Overcast Sequence', 
    ...
    # Save the figure
    output_path = 'sky3_results.png'
    plt.tight_layout()
    fig.savefig(output_path, dpi=300, bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    plt.close(fig)
    
    print(f"\n✅ Sky 3 results figure saved to: {output_path}")
